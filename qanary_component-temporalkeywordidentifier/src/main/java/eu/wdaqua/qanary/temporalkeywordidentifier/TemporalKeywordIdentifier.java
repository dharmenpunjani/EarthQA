package eu.wdaqua.qanary.temporalkeywordidentifier;
 ...
 */
public class TemporalKeywordIdentifier extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(TemporalKeywordIdentifier.class);
