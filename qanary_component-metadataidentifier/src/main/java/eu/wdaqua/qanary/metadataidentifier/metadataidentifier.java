package eu.wdaqua.qanary.metadataidentifier;
 ...
 */
public class metadataidentifier extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(metadataidentifier.class);
